...
// 검색 글 수
searchCount = dbPro.getSearchCount(searchCondition, searchKeyword);
...
if(searchCount > 0) {
	searchArticleList = dbPro.getSearchList(startRow, endRow, searchCondition, searchKeyword);
}
%>
...
<body>
	...
	%>
				<a href="/fortuneteller/index.jsp?page=review.jsp?pageNum=<%= startPage - pageBlock %>">[prev]&nbsp;</a>
		<%  }
			
			for(int i = startPage; i <= endPage; i++) {
				if(currentPage == i) {
		%>
				<a href="/fortuneteller/index.jsp?page=review.jsp?pageNum=<%= i %>" class="currentpage"><%= i %></a>&nbsp;
			<%  } else { %>
				<a href="/fortuneteller/index.jsp?page=review.jsp?pageNum=<%= i %>"><%= i %></a>&nbsp;
			<%  } %>
		...
		<%	}
			...
			if(endPage < pageCount) {
		%>
				<a href="/fortuneteller/index.jsp?page=review.jsp?pageNum=<%= startPage + pageBlock %>">&nbsp;[next]</a>
		<%		
			}
			...
			if(startPage > pageBlock) {
	%>
				<a href="/fortuneteller/index.jsp?page=review.jsp?pageNum=<%=startPage - pageBlock %>&searchCondition=<%= searchCondition %>&searchKeyword=<%=searchKeyword%>">[prev]&nbsp;</a>
		<%  }
			
			for(int i = startPage; i <= endPage; i++) {
				if(currentPage == i) {
		%>
				<a href="/fortuneteller/index.jsp?page=review.jsp?pageNum=<%= i %>&searchCondition=<%= searchCondition %>&searchKeyword=<%=searchKeyword%>" class="currentpage"><%= i %></a>&nbsp;
			<%  } else { %>
				<a href="/fortuneteller/index.jsp?page=review.jsp?pageNum=<%= i %>&searchCondition=<%= searchCondition %>&searchKeyword=<%=searchKeyword%>"><%= i %></a>&nbsp;
			<%  } %>
		...
		<%	}
			...
			if(endPage < pageCount) {
		%>
				<a href="/fortuneteller/index.jsp?page=review.jsp?pageNum=%=startPage + pageBlock %>&searchCondition=<%= searchCondition %>&searchKeyword=<%=searchKeyword%>">&nbsp;[next]</a>
		<%		
			}
		}
		%>
