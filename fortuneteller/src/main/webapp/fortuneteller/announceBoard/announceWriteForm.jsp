...
<body>
	...
	<div class="review_div">
		<form action="/fortuneteller/index.jsp?page=announceWriteProc.jsp" name="writeForm" method="post" class="review_form">
			<table class="review_table">
				...
				<tr class="review_table_tr">
					...
					<td colspan="2">	
						<input type="text" size="80" maxlength="50" name="nt_subject">
					</td>
				</tr>
				...
				<tr class="review_table_tr">
					...
					<td colspan="3">
						<textarea rows="13" cols="50" name="nt_content"></textarea>
					</td>
				</tr>
			</table>
